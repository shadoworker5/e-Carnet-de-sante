...
class Seting extends Component
{
    ...
    {
        return view('livewire.seting', ['list_regions' => Regions::where('contries_id', '=', Auth::user()->contrie_id)->get()->toArray(), 'list_provinces' => Provinces::where('region_id', '=', $this->region_id)->get()->toArray(), 'contries' => Contries::all()]);
    }
}