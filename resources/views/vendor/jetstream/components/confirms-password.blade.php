@props(['title' => __('Confirmer votre mot de passe'), 'content' => __('Veuillez confirmer votre mot de passe avant de continuer.'), 'button' => __('Confirm')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="form-control" placeholder="{{ __('Mot de passe') }}"
