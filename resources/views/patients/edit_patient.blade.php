        ...
        <div class="col-md-6 mt-3 offset-md-3 mb-2">
            ...
            <form action="{{ route('patient.update', $patient) }}" class="needs-validation" novalidate method="post">
                ...
                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" required name="name" id="name" value="{{ old('name') ?? $patient->full_name }}" placeholder="Nom complet">
                ...
                <div class="form-group {{ $errors->has('birthday') ? 'has-error' : '' }}">
                    ...
                    <input type="date" class="form-control" name="birthday" value="{{ old('birthday') ?? $patient->birthday }}" required id="birthday"/>
                ...
                <div class="form-group {{ $errors->has('father_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" name="father_name" id="father_name" required value="{{ old('father_name') ?? $patient->name_father }}" placeholder="Nom du père">
                ...
                <div class="form-group {{ $errors->has('mother_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" name="mother_name" required id="mother_name" value="{{ old('mother_name') ?? $patient->name_mother }}" placeholder="Nom de la mère">
                ...
                <div class="form-group {{ $errors->has('mentor_name') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" name="mentor_name" required id="mentor_name" value="{{ old('mentor_name') ?? $patient->name_mentor }}" placeholder="Nom du personne à prévenir">
                ...
                <div class="form-group {{ $errors->has('helper_contact') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" required name="helper_contact" id="helper_contact" value="{{ old('helper_contact') ?? $patient->helper_contact }}" placeholder="Contact en cas de besoin">
                ...
                <div class="form-group {{ $errors->has('helper_email') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" name="helper_email" id="helper_email" value="{{ old('helper_email') ?? $patient->helper_email }}" placeholder="E-mail (NP par défaut)">
