<div class="row">
    @if(in_array(Auth::user()->user_role, ['root', 'admin']))
        <select name="contry_id" id="contry_id" wire:model="contry_id" class="form-control mb-3" onchange="setContryID(this)">
    ...
    <div class="col-xl-6 col-lg-6">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary"> {{ __('Liste des régions') }} </h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button class="btn text-white" style="background-color: #e90000" data-bs-toggle="modal" data-bs-target="#del_region" onclick="delRegion('{{$region['id']}}')">
